...
/**
 * From https://github.com/riscv-non-isa/riscv-sbi-doc/blob/master/src/binary-encoding.adoc
 */
struct sbiret
{
  long error;
...
struct sbiret sbi_call(long n, long a, long b, long c,
                       long d, long e, long fid, long eid)
{
